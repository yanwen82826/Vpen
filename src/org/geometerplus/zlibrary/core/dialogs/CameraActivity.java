...
public class CameraActivity extends Activity {
	...
	private String DBTable, picFileName;
	private Bitmap bmp;
	int zoom;
	int maxZoom = 28;
...
/** Called when the activity is first created. */
	...
	public void onCreate(Bundle savedInstanceState) {
		  ...
		  id = bundle.getString("id");      //註記ID
		  type = bundle.getString("type");  //註記類型
		  DBTable = bundle.getString("db");
		  if(!FBReader.setImage){
			  picFileName = id+"_"+SaveValue.UserName+"_"+type+"_picture.jpg";
		  }
		  else{
			  picFileName = id+"_"+SaveValue.picLesson+"_"+SaveValue.UserName+"_"+type+"Anno_picture.jpg";
		  }
...
//		                  bos.close();
		                  ...
		                  db.updatePicture(Integer.parseInt(id), SaveValue.picUri, DBTable);
		                  //preview.closeCamera();
		                  //preview.closeCamera();
		    		  }
