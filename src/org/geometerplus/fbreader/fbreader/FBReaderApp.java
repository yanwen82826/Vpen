...
import org.geometerplus.android.fbreader.AnnotationSyncListAdapter;
import org.geometerplus.android.fbreader.FBReader;
import org.geometerplus.android.fbreader.ListViewMenu;
...
public final class FBReaderApp extends ZLApplication {
	...
	public final ZLIntegerRangeOption LeftMarginOption =
		new ZLIntegerRangeOption("Options", "LeftMargin", 0, 30, 0);
	public final ZLIntegerRangeOption RightMarginOption =
		new ZLIntegerRangeOption("Options", "RightMargin", 0, 30, 0);
	public final ZLIntegerRangeOption TopMarginOption =
		new ZLIntegerRangeOption("Options", "TopMargin", 0, 30, 0);
	public final ZLIntegerRangeOption BottomMarginOption =
		new ZLIntegerRangeOption("Options", "BottomMargin", 0, 30, 0);

	public final ZLIntegerRangeOption ScrollbarTypeOption =
		new ZLIntegerRangeOption("Options", "ScrollbarType", 0, 3, FBView.SCROLLBAR_HIDE);
	public final ZLIntegerRangeOption FooterHeightOption =
		new ZLIntegerRangeOption("Options", "FooterHeight", 8, 20, 0);
	...
	public FBReaderApp(String arg) {
		...
		addAction(ActionCode.SELECTION_BACKGROUND, new BackgroundColorAction(this));
	...
	public void initWindow() {
		...
		ZLDialogManager.Instance().wait("loadingBook", new Runnable() {
			public void run() {
				...
				//2011/10/19
				if( book == null )
					book = createBookForFile(ZLFile.createFileByPath("/mnt/sdcard/"+SaveValue.bookName));
				if( book == null )
					book = createBookForFile(ZLFile.createFileByPath("/mnt/sdcard/Books/"+SaveValue.bookName));
	...
	void openBookInternal(Book book, Bookmark bookmark) {
		Log.i("test tag11111", String.valueOf(Environment.getExternalStorageDirectory()));
		if (book != null) {
			onViewChanged();
			...
			Log.i("test tag22222", String.valueOf(Model == null));
			if (Model != null) {
	...
	//test
	public void setDB(SQLiteDB db){
		super.db = db;	
	}
	
	public void setMysql(ConnectMysql mysql) {
		super.mysql = mysql;
	}
	...
	public void setSync(SyncDB syncdb) {
		super.syncdb = syncdb;
	}
	
	public void setAdapter(AnnotationSyncListAdapter adapter, ListViewMenu lvm) {
		super.adter = adapter;
		super.lvm = lvm;
	}

	public void setLayout(RelativeLayout layout, FBReader fbReader) {
		super.fbread = fbReader;
		super.root = layout;
	}
}
